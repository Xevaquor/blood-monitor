    ...
    public void onBtnRegister(View view) {
        ...
        try {
            if (!etPassword.getText().toString().equals(etConfirmPassword.getText().toString())) {
                Toast.makeText(ctx, "hasła nie są identyczne!  :c", Toast.LENGTH_SHORT).show();
                return;
            ...
            JsonObjectRequest req = new JsonObjectRequest(
                    ...
                    new Response.Listener<JSONObject>() {
                        ...
                        public void onResponse(JSONObject response) {
                            ...
                            // Commit the edits!
                            editor.commit();
                            Toast.makeText(ctx, "Zarejestrowano", Toast.LENGTH_SHORT).show();
                            finish();
                        }
                    },
                    new Response.ErrorListener() {
                        ...
                        public void onErrorResponse(VolleyError error) {
                            ...
                            SharedPreferences.Editor editor = settings.edit();
                            editor.putBoolean("logged in", GlobalConfig.getInstance().isLoggedIn());
                            Toast.makeText(ctx, "Nie udało się zarejestrować", Toast.LENGTH_SHORT).show();
